...
static const unsigned int barvpad   = 7;        /* bar vertical padding */
...
static const char col_selbr[]       = "#7eb7ab";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_normfg, col_normbg, col_normbr },
	[SchemeSel]  = { col_selfg , col_selbg , col_selbr  },
};

/* alpha */
static const unsigned int alpha_scheme[3] = { 0xff, 0xe0, 0xe8 };
